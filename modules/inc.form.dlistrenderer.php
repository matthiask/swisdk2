<?php
	...
	*/
	...
	class DListFormRenderer extends FormRenderer {
		protected $html;
		protected $odd = true;
...
EOD;
		...
		protected function _render($obj, $field_html, $row_class=null)
		{
			...
			if($title)
				$this->html .= '<dt class="sf-element '.$row_class.'">'.$title.'</dt>';

			$this->html .= <<<EOD
<dd class="sf-element $row_class">
	$field_html
	<span class="sf-info">$info $message</span>
</dd>
